...
import jvsColorPicker from './colorPicker/index'
import jvsBackImg from './customBackImg/index'
import jvsSelectIcon from './customIconSelect/index.vue'
...
Vue.component('jvs-colorpicker', jvsColorPicker)
Vue.component('jvs-back-img', jvsBackImg)
Vue.component('jvs-select-icon', jvsSelectIcon)