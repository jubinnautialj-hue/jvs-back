...
export const getClassifyDictTree = (uniqueName) => {
  return request({
    url: `/mgr/jvs-design/base/form/design/tree/${uniqueName}`,
    method: "get"
  });
};
...
export const getSystemDict = (params) => {
  return request({
    url: `/mgr/jvs-auth/api/platform/dict/list/dicts`,
    method: "get",
    params: params
  });
};
...
export const getSystemDictItems = (uniqId) => {
  return request({
    url: `/mgr/jvs-design/base/form/design/items`,
    method: "get",
...
export const getModelSetting = (jvsAppId, modelId, designId) => {
  return request({
    url: `/mgr/jvs-design/app/design/${jvsAppId}/data/event/list/${modelId}/${designId}`,
    method: 'get'
  })
}
