  ...
  <div class="err-code-manage">
    ...
    >
      <template slot="menuLeft">
        <jvs-button type="primary" permisionFlag="jvs_gateway_encode_refresh" @click="handleRefresh()">{{$langt('table.freshCash')}}</jvs-button>
      </template>
...
<script>
import {addGatewayIgnore, delGatewayIgnore, editGatewayIgnore, getGatewayIgnoreList, refreshGatewayIgnore} from "./api";
  ...
  data () {
    return {
      ...
      tableOption: {
        ...
        search: true,
        // menu: false,
        addBtn: this.$permissionMatch("jvs_gateway_encode_add"),
        editBtn: this.$permissionMatch("jvs_gateway_encode_edit"),
        viewBtn: this.$permissionMatch(""),
        delBtn: this.$permissionMatch("jvs_gateway_encode_delete"),
        cancal: false,
        page: true,
        submitLoading: false,
        column: [
