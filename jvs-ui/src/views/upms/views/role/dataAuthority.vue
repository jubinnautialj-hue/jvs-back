<template>
  <div class="data-authority">
    <el-dialog
      ...
      :title="$langt('role.datapermision')"
      width="60%"
      :fullscreen="true"
      :visible.sync="dataAuthVisible"
      :close-on-click-modal="false"
      :before-close="handleClose">
      <div class="header-text">{{$langt('role.dataDesc')}}</div>
      <div class="data-authority-content">
              ...
              <div class="describes">
                ...
                >
                  <el-cascader
                    ...
                    :placeholder="$langt('role.dataColumn.deptIds')"
                    size="mini"
                    :options="treeData"
                    clearable
                  ...
                  <el-select :disabled="item.disabled" v-model="item.remark.jobIds" :placeholder="$langt('role.dataColumn.jobIds')" size="mini" multiple :collapse-tags="true" style="margin-left:10px;">
                    <el-option
                  ...
                  <el-cascader
                    ...
                    :placeholder="$langt('role.dataColumn.checkList')"
                    size="mini"
        ...
        <el-row style="display: flex;align-items: center;justify-content: center;background: #fff;padding:10px 0;">
          <el-button size="mini" type="primary" @click="handleConfirm">{{$langt('common.confirm')}}</el-button>
...
import {bindRoleDataAuth, getAllDataAuth, getRoleDataAuth} from "./api";
      ...
      bindRoleDataAuth(this.roleData.id, arr).then(res => {
        if (res.data && res.data.code == 0) {
          this.$notify({
            ...
            message: this.$langt('role.dataColumn.success'),
