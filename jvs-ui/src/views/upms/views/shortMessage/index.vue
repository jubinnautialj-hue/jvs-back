<template>
  <div class="short-message-page">
    ...
    <el-form v-if="$functionEnable('短信配置')" v-show="form.enable" style="width: 520px;" size="mini" ref="ruleForm" :rules="rules" :model="form" label-position="top" label-width="100px">
