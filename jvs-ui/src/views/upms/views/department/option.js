...
export const tableOption = {
  ...
  column: [
    ...
    },
    {
      ...
      // hide: (store.getters.userInfo.tenant && store.getters.userInfo.tenant.topTenant === true) ? false : true,
      search: true, // (store.getters.userInfo.tenant && store.getters.userInfo.tenant.topTenant === true) ? true : false,
    },
    {
      label: '性别',
      prop: 'sex',
...
export const formOptionColumn = [
  ...
  },
  {
    ...
    // display: (store.getters.userInfo.tenant && store.getters.userInfo.tenant.topTenant === true) ? true : false
  },
  {
    label: '性别',
    prop: 'sex',
