...
export const getGatewayIgnorePathPoList=(params) => {
  return request({
    url: `/mgr/jvs-auth/platform/GatewayXss/page`,
    method: 'get',
    params: params
  })
}
...
export const refreshGatewayIgnorePathPoList=(params) => {
  return request({
    url: `/mgr/jvs-auth/platform/GatewayXss/refresh`,
    method: 'get',
  })
}
...
export const addGatewayIgnorePathPo=(data) => {
  return request({
    url: `/mgr/jvs-auth/platform/GatewayXss/save`,
    method: 'post',
    data: data
  })
}
...
export const editGatewayIgnorePathPo=(data) => {
  return request({
    url: `/mgr/jvs-auth/platform/GatewayXss/edit`,
    method: 'put',
    data: data
  })
}
...
export const delGatewayIgnorePathPo=(id) => {
  return request({
    url: `/mgr/jvs-auth/platform/GatewayXss/del/${id}`,
    method: 'delete',
  })
}
