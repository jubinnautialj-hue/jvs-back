    ...
    <el-alert
      ...
      <template slot="title">
        <div class="alert-box">
          ...
          <span>邮件配置后，可使用逻辑组件灵活配置发送邮件内容，或发送用户邀请邮件！</span><span style="color: #3471ff;cursor: pointer;">如何获取配置</span>
        </div>
      </template>
    </el-alert>
    <el-form v-if="$functionEnable('邮件配置')" v-show="emailForm.enable" style="width: 520px;" size="mini" ref="ruleForm" :rules="rules" :model="emailForm" label-position="top" label-width="100px">
