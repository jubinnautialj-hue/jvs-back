  ...
  <div class="sms-dialog">
    ...
    <el-form style="width: 520px;" size="mini" ref="ruleForm" :rules="rules" :model="smsForm" label-position="top" label-width="100px">
      <el-form-item :label="$langt('message.smsColumn.personnel.label')" prop="personnel">
        <el-input :disabled="isView" :placeholder="$langt('message.smsColumn.personnel.placeholder')" v-model="smsForm.personnel" @focus="handleSelectUser"></el-input>
      </el-form-item>
      <el-form-item :label="$langt('message.smsColumn.templateId.label')" prop="templateId">
        <el-select :disabled="isView" style="width: 100%" v-model="smsForm.templateId" :placeholder="$langt('message.smsColumn.templateId.placeholder')" @change="handleTempChange">
          <el-option
      ...
      <el-form-item :label="$langt('message.smsColumn.paramName.label')" prop="paramName">
        <el-form size="mini" ref="propForm" :rules="propRules" :model="smsForm.extension">
          <el-form-item v-for="(item, key) in propList" :key="key" :label="item" :prop="item">
            <el-input :disabled="isView" :placeholder="`${$langt('message.smsColumn.paramName.placeholder')}${item}`" v-model="smsForm.extension[item]"></el-input>
          </el-form-item>
        </el-form>
      </el-form-item>
    </el-form>
