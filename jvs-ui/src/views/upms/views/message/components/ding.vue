  ...
  <div class="ding-dialog">
    ...
    <el-form style="width: 520px;" size="mini" ref="ruleForm" :rules="rules" :model="dingForm" label-position="top" label-width="100px">
      <el-form-item :label="$langt('message.smsColumn.personnel.label')" prop="personnel">
        <el-input :disabled="isView" :placeholder="$langt('message.smsColumn.personnel.placeholder')" v-model="dingForm.personnel" @focus="handleSelectUser"></el-input>
      </el-form-item>
      <el-form-item :label="$langt('message.column.messContent.label')" prop="content">
        <el-input :disabled="isView" :placeholder="$langt('message.column.messContent.placeholder')" v-model="dingForm.content" type="textarea"></el-input>
      </el-form-item>
    </el-form>
