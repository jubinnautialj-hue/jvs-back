            ...
            <div>
              ...
              >
                <div class="headeritem">
                  ...
                  <!-- 一般项 -->
                  <FormItem :form='dynamicValidateForm' :item='ci' style="flex:1;" v-if='["tableForm", "step", "formbox", "divider","p","tab", "reportTable"].indexOf(ci.type) == -1' :originOption="{...formsetting, formAlign: formsetting.labelposition}" :designId="designId" />
                  <!-- 分割线 -->
...
export default {
  components: {
    ...
    collapseForm: () => import('.//collapseForm'),
    tableForm,
    ...
    drop () {
      ...
      if(bool) {
        if (['section', 'formbox', 'htmlEditor'].indexOf(this.com.type) == -1 ) {
          ...
          this.com.parentKey = this.data.prop
