    ...
    <div class="card-list">
      ...
      <div class="user-info-card tenant-card">
        <div class="user-info-card-item">
          <div class="left">
            <h5><span v-if="tenantInfo">{{tenantInfo.name}}</span>账号信息</h5>
          </div>
          <div class="right">
<!--            <jvs-button v-if="changeTenantsList && changeTenantsList.length > 1" style="color: #3471FF;" type='text' @click="switchTenant">切换组织</jvs-button>-->
        ...
        <div class="user-info-top">
          ...
          <div style="margin-right: 12%;">
            ...
            <div>
              <span style="color: #a2a3a5;margin-right: 16px;">岗位</span>
...
<!--        </div>-->
      ...
      <div class="user-info-card tenant-card">
        ...
        <div class="user-info-card-item" v-if="enableTypeList.indexOf('WECHAT_MP') > -1">
          ...
          <div class="right">
             <jvs-button type="text" style="color: #3471FF;" @click="bindOprateHandle('wx')">{{(userdata.exceptions && userdata.exceptions.WECHAT_MP) ? '解除绑定' : '绑定微信'}}</jvs-button>
          </div>
        </div>
        <div class="user-info-card-item">
          <div class="left">
