<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" >每周</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="5" size="mini" >不指定</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="2" size="mini" >周期</el-radio>
    ...
    <div>
      <el-radio v-model="type" label="3" size="mini" >循环</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">从星期</span>
    ...
    <div>
      <el-radio v-model="type" label="7" size="mini" >指定周</el-radio>
    ...
    <div>
      <el-radio v-model="type" label="6" size="mini" >本月最后一个</el-radio>
    ...
    <div>
      <el-radio v-model="type" label="4" size="mini" >具体天(可多选)</el-radio>
      <el-select v-model="appoint" multiple placeholder="请选择" size="mini">
        <el-option
          v-for="i in 7"
          :key="i"
          :label="i"
