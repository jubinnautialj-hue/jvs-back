<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" >每日</el-radio>
    </div>
    <div>
    ...
    <div>
      <el-radio v-model="type" label="8" size="mini" >工作日</el-radio>
    ...
    <div>
      <el-radio v-model="type" label="4" size="mini" >具体天数(可多选)</el-radio>
