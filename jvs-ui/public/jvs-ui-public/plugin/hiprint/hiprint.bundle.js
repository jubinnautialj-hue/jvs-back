    ...
    var _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17),
        ...
        BasePrintElement = function () {
            ...
            return BasePrintElement.prototype.getConfigOptionsByName = function (t) {
                ...
                }), this.bingCopyEvent(this.designTarget), this.bingKeyboardMoveEvent(this.designTarget, e), this.initContext(this.designTarget, e, this);
            ...
            }, BasePrintElement.prototype.initContext = function (t, e, th) { // wyQAQ---- 右键删除
                $(t.find(".hiprint-printElement-content")).hicontextMenu({
                    menus: [{
                        text: "删除",
                        enabled: true,
                        callback: function callback() {
                            th.panel.deletePrintElement(th)
                        }
                    }]
                });
                // 图片
                $(t.find(".hiprint-printElement-image-content")).hicontextMenu({
                    menus: [{
                        text: "删除",
                        enabled: true,
                        callback: function callback() {
                ...
                // 选中状态
                $(t.find(".resize-panel")).hicontextMenu({
                    menus: [{
                        text: "删除",
                        enabled: true,
                        callback: function callback() {
    ...
    window, document, n = jQuery, (i = function i(t, e) {
        this.init(t, e);
            ...
            renderMenu: function renderMenu(t, e) {
                ...
                if (t && t.length) {
                    var o = $('<ul class="hicontextmenu'+ (t.length == 1 ? ' justone' : '')  +'" ></ul>');
    ...
    var _r,
        ...
        v = function (t) {
            ...
            return m(e, t), e.prototype.getReizeableShowPoints = function () {
                ...
                var n = $('<div  class="hiprint-printElement hiprint-printElement-image" style="position: absolute;width: 178px;height: 178px;"><div class="hiprint-printElement-image-content" style="height:100%;width:100%"></div></div>');
        ...
        q = function (t) {
            function e(e, option) {
                ...
                var tempList = []
                // wyQAQ
                if(option && option.columns && option.columns.length > 0) {
                    if(option.columns[0].columns) {
                        for(var cix in option.columns[0].columns) {
                            tempList.push(new u.a({ 
                                width: (option.columns[0].columns[cix].width || 100),
                                title: option.columns[0].columns[cix].title,
                                field: option.columns[0].columns[cix].field,
                                colspan: option.columns[0].columns[cix].colspan,
                                rowspan: option.columns[0].columns[cix].rowspan
                            }))
                        }
                    }
                }
                (e = e || {}).columns ? (n.columns = [], e.columns.forEach(function (t) {
                    ...
                    // wyQAQ   根据option设置列
                })) : (option ? (n.columns = [new K.a({columns: tempList})]) : (n.columns = [new K.a({columns: [new u.a({ width: 100 }), new u.a({ width: 100 })]})])
                );
        ...
        J = function (t) {
            function e(e, n) {
                ...
                // wyQAQ
                var outoption = null
                if(JSON.parse(JSON.stringify(i)).printElementType.myOption) {
                    outoption = JSON.parse(JSON.stringify(i)).printElementType.myOption
                }
                return i.options = new q(n, outoption), i.options.setDefault(new q(p.a.instance.tableCustom.default, outoption).getPrintElementOptionEntity()), i.columns = i.options.columns, i;
            }
            ...
            return Y(e, t), e.prototype.updateDesignViewFromOptions = function () {
                ...
                }), this.bingKeyboardMoveEvent(this.designTarget, e), this.initContext(this.designTarget, this); // wyQAQ-------右键删除
            ...
            }, e.prototype.initContext = function (t, e) { // wyQAQ-------右键删除
                $(t.find(".hiprint-printElement-table-handle")).hicontextMenu({
                    menus: [{
                        text: "删除",
                        enabled: true,
                        callback: function callback() {
                            e.panel.deletePrintElement(e)
                        }
                    }]
                });
            }, e;
            ...
            return t.getElementTypeGroups = function (e) {
                ...
                e.hidraggable({
                    ...
                    onBeforeDrag: function onBeforeDrag(e) {
                        ...
                        // wyQAQ
                        if($(e.data.target).length > 0 && $(e.data.target)[0].dataset && $(e.data.target)[0].dataset.options) {
                            let tops = JSON.parse($(e.data.target)[0].dataset.options)
                            for(let tk in tops) {
                                if(tops[tk]) {
                                    if(tk == 'columns') {
                                        n.myOption = tops
                ...
                t.getTarget().hidroppable({
                    ...
                    onDrop: function onDrop(n, i) {
                        var r = s.a.instance.getDragingPrintElement(),
                            a = r.printElement;
                        // wyQAQ
                        if(i.dataset && i.dataset.options) {
                            let tops = JSON.parse(i.dataset.options)
                            for(let tk in tops) {
                                if(tops[tk]) {
                                    if(tk != 'columns') {
                                        a.options[tk] = tops[tk]
                                    }
                                }
                            }
                        }
