...
import cn.bctools.message.push.dto.messagepush.dingtalk.robot.ActionCardSingleMessageDTO;
...
@Component
@AllArgsConstructor
public class ActionCardSingleMessageHandler extends BaseMessageHandler<ActionCardSingleMessageDTO> {
    ...
    public void handle(ActionCardSingleMessageDTO param) {
        ...
        MessagePushHis messagePushHis = new MessagePushHis()
                ...
                .setMessageType(MessageTypeEnum.DING_TALK_ROBOT_ACTION_CARD_SINGLE);
        ...
        try {
            ...
            actioncard.setSingleTitle(param.getSingleTitle());
            actioncard.setSingleURL(param.getSingleUrl());
