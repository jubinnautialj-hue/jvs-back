...
import cn.bctools.message.push.dto.messagepush.wechatwork.agent.VideoMessageDTO;
...
@Component
@AllArgsConstructor
public class AgentVideoMessageHandler extends BaseMessageHandler<VideoMessageDTO> {
    ...
    public void handle(VideoMessageDTO param) {
        ...
        param.getDefinedReceivers().forEach(e -> {
            MessagePushHis messagePushHis = new MessagePushHis()
                    ...
                    .setMessageType(MessageTypeEnum.WECHAT_WORK_AGENT_VIDEO);
    ...
    public void resend(String pushHisId) throws Exception {
        ...
        VideoMessageDTO dto = JSON.parseObject(his.getMessageContent(), VideoMessageDTO.class);
