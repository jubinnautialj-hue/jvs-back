...
@Component
@AllArgsConstructor
public class TextMessageHandler extends BaseMessageHandler<TextMessageDTO> {
    ...
    public void handle(TextMessageDTO param) {
        ...
        MessagePushHis messagePushHis = new MessagePushHis()
                ...
                .setMessageType(MessageTypeEnum.WECHAT_WORK_ROBOT_TEXT);
        ...
        try {
            ...
            messageParam.set("msgtype", "text");
            messageParam.set("text", jsonObject);
