...
import cn.bctools.message.push.dto.messagepush.wechatwork.robot.ArticleDTO;
...
@Component
@AllArgsConstructor
public class NewsMessageHandler extends BaseMessageHandler<NewsMessageDTO> {
    ...
    public void handle(NewsMessageDTO param) {
        ...
        MessagePushHis messagePushHis = new MessagePushHis()
                ...
                .setMessageType(MessageTypeEnum.WECHAT_WORK_ROBOT_NEWS);
        try {
            ...
            jsonObject.set("articles", articleJsons);
            ...
            messageParam.set("msgtype", "news");
            messageParam.set("news", jsonObject);
