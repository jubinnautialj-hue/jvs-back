...
public class UserCurrentUtils {
    ...
    public static String getRealName() {
        return Optional.ofNullable(getNullableUser()).map(UserDto::getRealName).orElse(null);
    }
    ...
    public static String getUserId() {
        return Optional.ofNullable(getNullableUser()).map(UserDto::getId).orElse(null);
    }
