...
//        System.out.println(PasswordUtil.encodePassword(str.toString(), SpringContextUtil.getKey()).length());
//        String eos = compress(str);
//        System.out.println(eos.length());
//        System.out.println(PasswordUtil.encodePassword(eos, SpringContextUtil.getKey()).length());
