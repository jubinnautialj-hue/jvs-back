...
public class XxlJobConfig {
     ...
     * xxl-job管理地址
     */
    @Value("${xxl.job.admin.addresses:http://jvs-xxl-job-admin:9090/xxl-job-admin}")
     ...
     * 日志保存地址
     */
    @Value("${xxl.job.executor.logpath:log/${spring.application.name}/xxl-job}")
    ...
    /**
     * Admin biz client admin biz client.
     *
     * @return the admin biz client
     */
    @Bean
    AdminBizClient adminBizClient(){
        return new AdminBizClient(adminAddresses,accessToken);
    }
