...
public class DefaultOperatorAnnotationHandlerRegister implements OperatorAnnotationHandlerRegister {
    protected final Map<Class<? extends Annotation>, OperatorAnnotationHandler> annotationHandlerMap = new HashMap<>(8);
    ...
    public Map<Class<? extends Annotation>, OperatorAnnotationHandler> getAllRegisteredHandler() {
        Map<Class<? extends Annotation>, OperatorAnnotationHandler> copyAnnotationHandlerMap = new HashMap<>(8);
