 ...
 * 通过实现{@linkplain IJvsParam}接口不同的场景扩展业务  并通过{@linkplain ExpressionHandler#calculate(java.lang.String, java.util.Map, java.lang.String)}执行动态脚本
 * <p>
 * <p>
 * 通过界面操作编写动态脚本进行执行
 *
...
public @interface JvsExpression {
     ...
     * <p>
     * 详情见{@link ExpressionController#getAllFunctions(java.lang.String, java.lang.String, java.lang.String, java.lang.String)}
     */
    String groupName();
