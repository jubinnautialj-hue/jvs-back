...
public interface AuthUserServiceApi {
     ...
     * @return 用户信息集合 by ids
     */
    @PostMapping(PREFIX + "/query/user/by/ids")
    R<List<UserDto>> getByIds(@RequestBody List<String> userIds);
     ...
     * @return the by names
     */
    @PostMapping(PREFIX + "/query/user/by/names")
    R<List<UserDto>> getByNames(@RequestBody List<String> userNames);

    /**
     * 根据角色id集合查询用户对象集合
     *
     * @param roleIds 角色id集合
     * @return 用户信息集合 by role ids
     */
    @PostMapping(PREFIX + "/query/user/by/role/ids")
    R<List<UserDto>> getByRoleIds(@RequestBody List<String> roleIds);

    /**
     * 根据部门id集合查询用户对象集合
     *
     * @param deptIds 部门id集合
     * @return 用户信息集合 by dept ids
     */
    @PostMapping(PREFIX + "/query/user/by/dept/ids")
    R<List<UserDto>> getByDeptIds(@RequestBody List<String> deptIds);

    /**
     * 通过部门id获取用户数据(无权限,角色数据)
     *
     * @param deptId 部门id
     * @return 用户数据集合 by dept id
     */
     ...
     *
     * @param jobIds 职位id集合
     * @return 用户信息集合 by job ids
     */
    @PostMapping(PREFIX + "/query/user/by/job/ids")
    R<List<UserDto>> getByJobIds(@RequestBody List<String> jobIds);
    ...
    /**
     * 根据不同的类型查询返回多种公共结果
     * 提供用户\角色\部门\岗位\群组id数组
     *
     * @param dto 用户\角色\部门\岗位\群组id数组
     * @return 用户 \角色\部门\岗位\群组数组
     */
    @PostMapping(PREFIX + "/query/base/search")
    R<BaseFindReturnDto> baseSearch(@RequestBody BaseFindDto dto);

    /**
     * 根据部门id查询该部门的负责人
     *
     * @param deptId 部门id
     * @return 用户信息 dept leader by id
     */
     ...
     *
     * @param deptId 部门id
     * @return 用户信息 upper dept leader by id
     */
     ...
     *
     * @param userIds 用户数组
     * @return 返回用户对象信息 basic info by id
     */
    @PostMapping(value = "/user/get/basic")
    R<List<UserDto>> getBasicInfoById(@RequestBody List<String> userIds);

    /**
     * 指定field查询, 优化查询速度
     *
     * @param userIds 用户数组
     * @param field   需要查询的字段,字段,字段与${@linkplain UserDto}一致 如 id
     * @return 返回多个用户对象 basic info by id
     */
