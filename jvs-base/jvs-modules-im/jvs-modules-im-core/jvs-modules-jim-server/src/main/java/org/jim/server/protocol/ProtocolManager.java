...
public class ProtocolManager implements ImConst{
	...
	public static class Packet{
		 ...
		 * @throws ImException
		 */
		public static ImPacket  dataInCorrect(Command command, ImChannelContext imChannelContext) throws ImException{
		 ...
		 * @throws ImException
		 */
		public static ImPacket  success(Command command, ImChannelContext imChannelContext) throws ImException{
