...
public interface ImConst
{
	...
	/***************Redis key****************/
	String PREFIX_STORE = JIM + SUFFIX + "store";
	
	String PREFIX_PUSH = JIM + SUFFIX + "push";

	String PREFIX_BUSINESS = JIM + SUFFIX + "business";
	...
	/** 用户组key前缀 */
	String PREFIX_GROUP = JIM + SUFFIX + GROUP;

	/** 用户key前缀 */
	String PREFIX_USER = JIM + SUFFIX + USER;
