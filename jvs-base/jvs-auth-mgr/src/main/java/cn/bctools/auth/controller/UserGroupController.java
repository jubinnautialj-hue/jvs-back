...
public class UserGroupController {
    ...
    @GetMapping("/users")
    public R<Page<UserVo>> users(@RequestParam(value = "groupId", required = false) String groupId, PageDTO<UserTenant> page) {
    ...
    public R<List<UserBelongGroupVO>> belongList() {
        List<UserGroup> list = userGroupService.list(Wrappers.<UserGroup>lambdaQuery().apply(SqlFunctionUtil.jsonContains("users", UserCurrentUtils.getCurrentUser().getId(), "$")));
