...
public class GrayReactiveLoadBalancerClientFilter extends ReactiveLoadBalancerClientFilter {
    ...
    public GrayReactiveLoadBalancerClientFilter(GatewayLoadBalancerProperties properties, DiscoveryClient discoveryClient, VersionLoadBalancer versionLoadBalancer) {
        super(null, properties);
        this.loadBalancerProperties = properties;
        this.discoveryClient = discoveryClient;
        this.versionLoadBalancer = versionLoadBalancer;
    }
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if ((!LOAD_BALANCE.equals(url.getScheme()) && !LOAD_BALANCE.equals(schemePrefix))) {
    ...
    private Mono<Response<ServiceInstance>> choose(ServerWebExchange exchange) {
        ...
        ServiceInstance serviceInstance = versionLoadBalancer.choose(discoveryClient, uri.getHost(), exchange.getRequest());
