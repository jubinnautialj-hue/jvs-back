...
public class UserRoleServiceImpl extends ServiceImpl<UserRoleMapper, UserRole> implements UserRoleService {
    ...
    public List<Role> getRoleByUserId(String userId) {
        ...
        if (ObjectUtil.isNotEmpty(list)) {
            ...
            return roleMapper.selectBatchIds(collect).stream().collect(Collectors.toList());
        }
        return new ArrayList<>();
    }

    @Override
    public Map<String, List<Role>> getRoleByUserId(Collection<String> userId) {
    ...
    @Override
    public void clearRoleUser(String roleId) {
        this.remove(Wrappers.<UserRole>lambdaQuery().eq(UserRole::getRoleId, roleId));
    }
}
