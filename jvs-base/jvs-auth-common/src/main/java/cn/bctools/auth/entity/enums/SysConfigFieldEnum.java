...
public enum SysConfigFieldEnum {
    ...
    DEPT_ID_ATTRIBUTE("deptIdAttribute", "LDAP OU全局唯一id", Boolean.FALSE),
    USER_OBJECT_CLASS("userObjectClass", "LDAP用户搜索ObjectClass。多个以英文逗号分割", Boolean.FALSE),
    OU_OBJECT_CLASS("ouObjectClass", "LDAP组织搜索ObjectClass多个以英文逗号分割", Boolean.FALSE),
    ;
