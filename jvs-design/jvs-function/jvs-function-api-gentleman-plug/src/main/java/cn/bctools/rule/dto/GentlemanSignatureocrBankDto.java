...
/**
 * The type Gentleman signatureocr bank dto.
 *
 * @author jvs
 */
@Data
...
@AllArgsConstructor
@NoArgsConstructor
public class GentlemanSignatureocrBankDto extends JunZiQianBaseDto {
    /**
     * The File.
     */
     ...
     * The Img http url.
     */
    @ParameterValue(info = "图片url地址,图片不能超2mb,图片分辨率不能超4k", necessity = false, type = InputType.input)
