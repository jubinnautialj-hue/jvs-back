...
/**
 * The type Gentleman signatureadd case party dto.
 *
 * @author jvs
 */
@Data
...
@AllArgsConstructor
@NoArgsConstructor
public class GentlemanSignatureaddCasePartyDto extends JunZiQianBaseDto {
    /**
     * The Order no.
     */
    @ParameterValue(info = "仲裁申请订单号", type = InputType.input)
