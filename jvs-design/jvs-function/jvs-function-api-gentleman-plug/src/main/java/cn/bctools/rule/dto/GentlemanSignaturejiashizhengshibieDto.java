...
/**
 * The type Gentleman signaturejiashizhengshibie dto.
 *
 * @author jvs
 */
@Data
...
@AllArgsConstructor
@NoArgsConstructor
public class GentlemanSignaturejiashizhengshibieDto extends JunZiQianBaseDto {
    /**
     * The File.
     */
    ...
    /**
     * The Driving license side.
     */
    @ParameterValue(info = "0：识别驾驶证副页；不传或者其他非值：识别驾驶证正页、电子驾驶证正页", necessity = false, type = InputType.number)
    public Integer drivingLicenseSide;
