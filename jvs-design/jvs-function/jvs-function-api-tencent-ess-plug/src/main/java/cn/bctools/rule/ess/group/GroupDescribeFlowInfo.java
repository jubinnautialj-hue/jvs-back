...
public class GroupDescribeFlowInfo {
     ...
     * @param flowId              流程id
     * @return DescribeFlowInfoResponse describe flow info response
    ...
    public static void main(String[] args) {
        try {
            ...
            DescribeFlowInfoResponse response = describeFlowInfo(Config.OPERATOR_USER_ID, proxyOrganizationId, flowId);
