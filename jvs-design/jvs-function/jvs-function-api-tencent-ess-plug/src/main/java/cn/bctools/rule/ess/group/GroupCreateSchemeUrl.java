...
public class GroupCreateSchemeUrl {
     ...
     * @param flowId              流程id
     * @return CreateSchemeUrlResponse create scheme url response
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateSchemeUrlResponse response = createSchemeUrl(Config.OPERATOR_USER_ID, proxyOrganizationId, flowId);
