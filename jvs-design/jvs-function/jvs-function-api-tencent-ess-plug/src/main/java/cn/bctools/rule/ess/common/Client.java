...
public class Client {
    ...
    public static EssClient getEssClient() {
        return getEssClient(Config.SECRET_ID, Config.SECRET_KEY, Config.END_POINT);
    }
    ...
    public static EssClient getEssFileClient() {
        return getEssClient(Config.SECRET_ID, Config.SECRET_KEY, Config.FILE_SERVICE_END_POINT);
    }
