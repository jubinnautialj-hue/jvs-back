...
public class BindingEmployeeUseridToCustomerSystemOpenidDto {
    ...
    @ParameterValue(info = "(OpenId)员工在贵司业务系统中的唯一身份标识，用于与腾讯电子签账号进行映射，确保在同一企业内不会出现重复。 该标识最大长度为64位字符串，仅支持包含26个英文字母和数字0-9的字符。", necessity = false, type = InputType.input)
