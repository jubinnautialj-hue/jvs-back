...
/**
 * @author jvs
 * The type Query the detailed information of the contract process dto.
 */
@Data
@Accessors(chain = true)
public class QueryTheDetailedInformationOfTheContractProcessDto {
     ...
     * The Flow group id.
     */
    @ParameterValue(info = "(FlowGroupId)合同组ID, 如果传此参数会忽略FlowIds入参", necessity = false, type = InputType.input)
