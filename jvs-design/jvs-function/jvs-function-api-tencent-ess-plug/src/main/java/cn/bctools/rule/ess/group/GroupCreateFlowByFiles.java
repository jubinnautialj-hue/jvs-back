...
public class GroupCreateFlowByFiles {
     ...
     * @return 流程id即flowId create flow by files response
    ...
    public static void main(String[] args) {
        try {
            ...
            CreateFlowByFilesResponse response = createFlowByFiles(OPERATOR_USER_ID, proxyOrganizationId, flowName, approvers, fileId);
