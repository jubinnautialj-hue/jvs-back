...
public class GroupDescribeOrganizationSeals {
     ...
     * @return DescribeOrganizationSealsResponse describe organization seals response
    ...
    public static void main(String[] args) {
        try {
            ...
            long limit = 10L;
            DescribeOrganizationSealsResponse response = describeOrganizationSeals(Config.OPERATOR_USER_ID, proxyOrganizationId, limit);
