...
//        iconUrl = "rule-dysmsduanxinfuwu",
        explain = "用于撤销合同流程\n" +
                ...
                "\n" +
                "注: 如果合同流程中的参与方均已签署完毕，则无法通过该接口撤销合同，签署完毕的合同需要双方走解除流程将合同作废，可以参考发起解除合同流程接口。"
)
@AllArgsConstructor
public class RevokingSingleContractProcessServiceImpl implements BaseCustomFunctionInterface<RevokingSingleContractProcessDto> {

    @Override
    public Object execute(RevokingSingleContractProcessDto dto, Map<String, Object> params) {
        ...
        try {
            ...
            req.setCancelMessage(dto.getCancelMessage());
