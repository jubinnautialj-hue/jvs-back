...
public class PostgreSqlServiceImpl implements BaseCustomFunctionInterface<PostgreSqlFunctionDto> {

    @Override
    public Object execute(PostgreSqlFunctionDto esFunctionDto, Map<String, Object> params) {
        return null;
    }
}
