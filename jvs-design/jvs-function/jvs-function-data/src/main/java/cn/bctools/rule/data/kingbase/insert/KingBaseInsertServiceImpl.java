package cn.bctools.rule.data.kingbase.insert;
...
@AllArgsConstructor
public class KingBaseInsertServiceImpl implements BaseCustomFunctionInterface<KingBaseInsertDto> {

    ModelInterface modelInterface;

    @Override
    public Object execute(KingBaseInsertDto dto, Map<String, Object> params) {
        ...
        try {
            return ClientConfig.init(option, KingBase_templateFunction).insertData(replace);
