package cn.bctools.rule.data.mysql.page;
...
public class MysqlPageDto {
    ...
    @ParameterValue(info = "页大小", type = InputType.number)
    public Integer size = 10;

    /**
     * 当前页
     */
    @ParameterValue(info = "页码数", type = InputType.number)
