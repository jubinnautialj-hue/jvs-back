...
import cn.bctools.rule.data.dm.DmEnvironmentVariableSelected;
...
@AllArgsConstructor
@NoArgsConstructor
public class DMFunctionDto {

    @NotNull(message = "数据源不能为空")
    @ParameterValue(info = "目标数据源", type = InputType.selected,  cls = DmEnvironmentVariableSelected.class)
