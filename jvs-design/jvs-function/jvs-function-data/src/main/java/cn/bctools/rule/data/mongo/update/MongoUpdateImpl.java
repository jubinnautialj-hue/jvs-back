package cn.bctools.rule.data.mongo.update;
...
public class MongoUpdateImpl implements BaseCustomFunctionInterface<UpdateDto> {
     ...
     */
    @Override
    public Object execute(UpdateDto updateDto, Map<String, Object> params) {
        Object byKey = modelInterface.getByKey(updateDto.getOptions());
        MongoDBOption mongoDBOption = BeanCopyUtil.copy(MongoDBOption.class, byKey);

        mongoCustomTemplate.update(mongoDBOption, updateDto.getTableName(), updateDto.queryArgs, updateDto.getBody());
