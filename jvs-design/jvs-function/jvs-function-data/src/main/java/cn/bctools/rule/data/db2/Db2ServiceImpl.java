...
public class Db2ServiceImpl implements BaseCustomFunctionInterface<Db2FunctionDto> {

    @Override
    public Object execute(Db2FunctionDto db2FunctionDto, Map<String, Object> params) {
        return null;
    }
