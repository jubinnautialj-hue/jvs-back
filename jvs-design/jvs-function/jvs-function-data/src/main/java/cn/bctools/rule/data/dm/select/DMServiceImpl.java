package cn.bctools.rule.data.dm.select;
...
@AllArgsConstructor
public class DMServiceImpl implements BaseCustomFunctionInterface<DMFunctionDto> {
    ModelInterface modelInterface;

    @Override
    public Object execute(DMFunctionDto dto, Map<String, Object> params) {
        ...
        try {
            return ClientConfig.init(option, dm_templateFunction).queryData(replace, dto.getResultType());
