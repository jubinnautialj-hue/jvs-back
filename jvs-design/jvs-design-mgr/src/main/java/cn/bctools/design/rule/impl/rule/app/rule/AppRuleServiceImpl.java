...
@AllArgsConstructor
public class AppRuleServiceImpl implements BaseCustomFunctionInterface<AppRuleDto> {

    @Override
    public Object execute(AppRuleDto dto, Map<String, Object> params) {
        ...
        RuleDesignPo po = ruleService.getEnableDesign(dto.getKey());
        ...
        try {
            RuleExecuteDto run = bean.run(dto.getKey(), dto.getBody());
            if ("提示消息".equals(run.getEndResult().getFunctionName())) {
                //表示程序中止
