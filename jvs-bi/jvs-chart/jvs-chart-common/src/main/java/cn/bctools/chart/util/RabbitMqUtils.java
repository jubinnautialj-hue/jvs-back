...
public class RabbitMqUtils {
     ...
     * 交换机名称
     */
    public static final String EXCHANGE_TOPICS_DATA_FACTORY_TASK = "exchange_topics_chart_task";
    /**
     * 队列名称 任务执行
     */
    public static final String QUEUE_DATA_FACTORY_TASK = "queue_chart_task";
    /**
     * 队列名称 消息推送
     */
    public static final String QUEUE_DATA_FACTORY_TASK_NOTICE = "queue_down_chart_task";

    /**
     * 队列名称 血缘视图
     */
    public static final String CONSANGUINITY_ANALYSE_TASK = "queue_down_all_task";
