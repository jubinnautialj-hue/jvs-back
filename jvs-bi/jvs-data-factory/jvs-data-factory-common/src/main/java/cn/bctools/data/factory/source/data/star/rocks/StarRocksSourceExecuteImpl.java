package cn.bctools.data.factory.source.data.star.rocks;
 ...
 * @author xiaohui
 */
@Component(value = "starRocksDataSource")
@Slf4j
public class StarRocksSourceExecuteImpl implements DataSourceExecuteInterface {
