...
@Getter
@AllArgsConstructor
public enum ApiDataFieldTypeEnum {
    ...
    public static ApiDataFieldTypeEnum value(Class<?> aClass) {
        if (aClass != null) {
            for (ApiDataFieldTypeEnum value : ApiDataFieldTypeEnum.values()) {
    ...
    public static ApiDataFieldTypeEnum getType(Object obj) {
        for (ApiDataFieldTypeEnum value : ApiDataFieldTypeEnum.values()) {
